...
# --- STEP 1: PREPARATION ---
Write-Host "`nStep 1: Preparing directories and mock data..." -ForegroundColor Yellow
...
# --- STEP 2: DEPENDENCIES ---
Write-Host "`nStep 2: Verifying dependencies..." -ForegroundColor Yellow
...
Write-Host "`nStep 3: Running CDP Pipeline Checks (Lint/Format/Unit Tests)..." -ForegroundColor Yellow
$env:PYTHONPATH = "."
